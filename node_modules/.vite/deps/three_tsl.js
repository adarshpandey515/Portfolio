  ...
  *getChildren() {
  ...
  _getChildren(ignores = /* @__PURE__ */ new Set()) {
    ...
    for (const property3 of Object.getOwnPropertyNames(this)) {
      ...
      if (property3.startsWith("_") === true || ignores.has(object))
        continue;
...
var TextureNode = class extends UniformNode {
  ...
  setupUV(builder, uvNode) {
    if (builder.isFlipY()) {
      if (this._flipYUniform === null)
        this._flipYUniform = uniform(false);
      uvNode = uvNode.toVar();
      if (this.sampler) {
  ...
  setup(builder) {
    ...
    if (this.fragmentNode === null) {
      ...
      if (clippingNode !== null)
        builder.stack.addToStack(clippingNode);
